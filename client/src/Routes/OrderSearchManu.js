       ...
       // handleDropdownChange(); // Fetch seller data when component mounts
        const fetchOrders = async () => {
            try {
                ...
                const userOrders = order.filter(o => o.manufacturerGstno === user.gstno && o.fulfilled == false );
                            ...
                            {orders.map((order, index) => (
                                <tr key={index}>
                                    ...
                                    <td> {/* Column for Actions */}
                                        <button className="approve-btn" onClick={() => approveOrder(order.orderId)}>Accept Order</button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
